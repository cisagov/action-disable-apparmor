...
issue](https://github.com/cisagov/action-disable-apparmor/issues) in this
...
request](https://github.com/cisagov/action-disable-apparmor/pulls), you will
...
```console
cd action-disable-apparmor
pyenv virtualenv <python_version_to_use> action-disable-apparmor
pyenv local action-disable-apparmor
